...
INNER JOIN in departments dept ON deptmgr.dept_no = dept.dept_no
...
right JOIN departments dept ON depe.dept_no = dept.dept_no
order by emp.emp_no
...
--There are few ways to write this query the more efficient being with inner joins 
select 
